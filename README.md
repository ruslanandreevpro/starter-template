# Starter Template for Front-end Development Pug+SCSS

Если вам нравится то, что я делаю, был бы рад поддержке в виде любой суммы :beer:

[<img src="https://img.shields.io/badge/%D0%9D%D0%B0%20%D0%BF%D0%B8%D0%B2%D0%BE-5106%202180%203016%206888-informational.svg?style=for-the-badge">](https://money.yandex.ru/to/41001208516757)
...
* скачайте сборку с помощью [Git](https://git-scm.com/downloads): ```git clone https://github.com/ruslanandreevpro/starter-template.git```
* установите ```gulp``` и ```bem-tools-core``` глобально: ```yarn global add gulp-cli bem-tools-core```
* перейдите в скачанную папку со сборкой: ```cd starter-template```
